...
class DriverFactory:
    ...
    def get_chrome_driver(headless=False, maximize=True):
        ...
        # Determină extensia driver-ului în funcție de OS
        driver_ext = ".exe" if platform.system() == "Windows" else ""
        
        # Verifică dacă există chromedriver în directorul curent sau în PATH
        chromedriver_path = None
        local_paths = [
            os.path.join("drivers", f"chromedriver{driver_ext}"),  # Cale relativă la proiect
            f"chromedriver{driver_ext}"  # În directorul curent sau PATH
        ]
        ...
        if chromedriver_path:
            ...
            try:
                ...
                # Curăță cache-ul vechi dacă există probleme
